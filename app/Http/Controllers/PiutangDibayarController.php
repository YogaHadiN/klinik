...
class PiutangDibayarController extends Controller
{
	...
	public function update($id){
		...
		try {
			...
			//update jurnal_umum
			$jurnals = JurnalUmum::where('jurnalable_type', 'App\NotaJual')
			...
			$piutang_asuransi                = PiutangAsuransi::where('periksa_id', $piutang_dibayar->periksa_id)->first();
			$piutang_asuransi->sudah_dibayar = $piutang_asuransi->sudah_dibayar + $perubahan;
			$piutang_asuransi->save();

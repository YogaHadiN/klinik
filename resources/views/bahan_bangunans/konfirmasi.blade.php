					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<div class="form-group @if($errors->has('konfirmasi'))has-error @endif">
								...
								{!! Form::select('konfirmasi', App\Classes\Yoga::konfirmasi(), null, array(
						...
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<div class="form-group @if($errors->has('bangunan_permanen'))has-error @endif">
								...
								{!! Form::select('bangunan_permanen', App\Classes\Yoga::bangunanPermanen(), null, array(
									'class'         => 'form-control rq'
								))!!}
							...
							@if($datas->count() > 0)
								@foreach( $datas as $d )
									<tr>
										...
										<td>{{ $d->keterangan }}</td>
										<td class="text-right">{{App\Classes\Yoga::buatrp(  $d->harga_satuan * $d->jumlah )}}</td>
									</tr>
								@endforeach
							@else
								<tr>

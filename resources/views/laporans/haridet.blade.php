...
@section('title') 
{{ env("NAMA_KLINIK") }} | Laporan Harian Admedika
        ...
        <div class="panel panel-primary">
          <div class="panel-heading">
                <div class="panel-title">
                    <div class="panelLeft">
                        <h3>Laporan Tanggal : {!! App\Classes\Yoga::updateDatePrep($tanggal) !!} || Asuransi = {!! $asuransi !!}</h3>
                    </div>
                        ...
                        @if (count($periksas) > 0)
                            ...
                            <tr>
                                ...
                                <td>{!! $periksa->nama_pasien !!}</td>
                                    {!! App\Classes\Yoga::laporanRinci($rincian, $periksa) !!}

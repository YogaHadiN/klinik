								...
								<table class="table table-bordered table-hover" id="tableAsuransi">
									...
									<tbody>
										@if (count($tanggal) > 0)
											...
											<tr>
												...
												{!! App\Classes\Yoga::jenisTarifs($tgl, $rincian)!!}
									...
									<tfoot>
										<tr>
											...
											<td class="uang">{!! App\Classes\Yoga::totalTunaiDetBulan($tanggal) !!}</td>
											<td class="uang">{!! App\Classes\Yoga::totalPiutangDetBulan($tanggal) !!}</td>
											<td class="uang">{!! App\Classes\Yoga::modalBulanIni($tanggall, $asuransi_id) !!}</td>
										</tr>
									</tfoot>
								</table>
						  </div>

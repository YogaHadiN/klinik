...
@section('title') 
{{ env("NAMA_KLINIK") }} | Laporan Puskesmas Jumlah Diare periode {{ App\Classes\Yoga::updateDatePrep($mulai) }} s/d {{ App\Classes\Yoga::updateDatePrep($akhir) }}
...
@section('page-title') 
 ...
 <h2>Laporan Puskesmas Jumlah Diare periode {{ App\Classes\Yoga::updateDatePrep($mulai) }} s/d {{ App\Classes\Yoga::updateDatePrep($akhir) }}
</h2>
 <ol class="breadcrumb">
      <li>
      ...
      <li class="active">
          <strong>Laporan Puskesmas Jumlah Diare periode {{ App\Classes\Yoga::updateDatePrep($mulai) }} s/d {{ App\Classes\Yoga::updateDatePrep($akhir) }}
</strong>
      </li>
</ol>
@stop
    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <div class="panel panel-info">
              <div class="panel-heading">
                  Laporan Puskesmas Jumlah Diare periode {{ App\Classes\Yoga::updateDatePrep($mulai) }} s/d {{ App\Classes\Yoga::updateDatePrep($akhir) }}
              </div>

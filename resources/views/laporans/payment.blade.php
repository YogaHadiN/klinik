				...
				@if(count($hutang_asuransis) > 0)
					@foreach($hutang_asuransis as $hutang)
						<tr
							...
							@endif
							>
							<td>{{ App\Classes\Yoga::bulan($hutang->bulan) }} {{ $hutang->tahun }}</td>
							<td class="text-right">{{ App\Classes\Yoga::buatrp( $hutang->hutang ) }}</td>
							<td class="text-right">{{ App\Classes\Yoga::buatrp( $hutang->sudah_dibayar ) }}</td>
							<td class="text-right">{{ App\Classes\Yoga::buatrp( $hutang->hutang - $hutang->sudah_dibayar ) }}</td>

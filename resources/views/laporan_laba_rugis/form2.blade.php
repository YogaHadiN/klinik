				  ...
				  <table class="table table-bordered table-condensed">
					<tbody>
					  ...
					  <tr>
						...
						<td></td>
						<td nowrap class="text-right">{{App\Classes\Yoga::buatrp( $pendapatan_usahas['total_nilai']  )}}</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						...
						<td></td>
						<td nowrap class="text-right">({{App\Classes\Yoga::buatrp( $hpps['total_nilai'] )}})</td>
					  </tr>
					  ...
					  <tr>
						...
						<td></td>
						<td nowrap class="text-right">({{App\Classes\Yoga::buatrp(   $biayas['total_nilai'] )}})</td>
					  </tr>
					  <tr class="red light-bold">
						<td></td>
						<td></td>
						<td>Laba Rugi Kotor</td>
						<td></td>
						<td nowrap class="text-right">{{App\Classes\Yoga::buatrp(  $pendapatan_usahas['total_nilai']- $hpps['total_nilai'] -  $biayas['total_nilai'] )}}</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						...
						<td></td>
						<td nowrap class="text-right">{{App\Classes\Yoga::buatrp(   $pendapatan_lains['total_nilai'] )}}</td>
					  <tr class="red light-bold">
						<td colspan="2"></td>
						<td>Laba Rugi Bersih</td>
						<td></td>
						<td nowrap class="text-right">{{App\Classes\Yoga::buatrp(   ( $pendapatan_usahas['total_nilai'] - $hpps['total_nilai'] -  $biayas['total_nilai'] +  $pendapatan_lains['total_nilai']  ) )}}</td>
					  </tr>
					  </tr>
					</tbody>
				  </table>

...
@section('content') 
	...
	{!! Form::open(['url' => 'antrianpolis/pengantar/' . $ap->id . '/edit', 'method' => 'post', 'files' => 'true']) !!}
	@include('antrianpolis.pengantar_form', ['pengantar' => 'true', 'edit' => true, 'halamanAwal' => 'antrian_poli_id'])
@stop
@section('footer') 

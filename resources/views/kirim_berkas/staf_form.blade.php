		...
		<div class="row">
			<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
				<div class="form-group @if($errors->has('staf_id'))has-error @endif">
					...
					{!! Form::select('staf_id[]', App\Staf::pluck('nama', 'id')->all(), $staf->staf_id, array(
			...
			<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
				<div class="form-group @if($errors->has('role_pengiriman_id'))has-error @endif">
					...
					{!! Form::select('role_pengiriman_id[]', App\RolePengiriman::list(), $staf->role_pengiriman_id, array(
...
<div class="row">
	<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
		<div class="form-group @if($errors->has('staf_id'))has-error @endif">
			{!! Form::label('staf_id[]', 'Staf', ['class' => 'control-label']) !!}
			{!! Form::select('staf_id[]', App\Staf::pluck('nama', 'id')->all(), null, array(
				'class'            => 'form-control staf_id rq',
				'data-live-search' => 'true',
				'placeholder'      => 'Pilih Petugas'
			))!!}

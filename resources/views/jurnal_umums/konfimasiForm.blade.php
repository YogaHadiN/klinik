			...
			<div class="table-responsive">
				<div class="row">
					<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
						<table class="table table-hover table-condensed table-bordered table-keterangan">
							...
							<tbody>
								<tr>
									<td>{{ $fb->keterangan }}</td>
									<td>{{App\Classes\Yoga::updateDatePrep(  $fb->tanggal  )}}</td>
									<td class="text-right">{{App\Classes\Yoga::buatrp(  $fb->nilai  )}}</td>
								</tr>
							</tbody>
						</table>
						<div class="row">
						...
						<div class="table-responsive">
								...
								<table class="table table-hover table-condensed table-bordered table-alat">
									...
									<tfoot>
										<tr>
											...
											<td> {!! Form::select('masa_pakai', App\Classes\Yoga::masaPakai(), null, ['class' => 'form-control masa_pakai']) !!} </td>	
							...
							@elseif(   $ikhtisar == 'service_ac' )
								<table class="table table-hover table-condensed table-bordered table-alat">
									...
									<tfoot>
										<tr>
											<td> {!! Form::select('ac_id', App\Ac::list(), null, ['class' => 'form-control ac_id']) !!} </td>	
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
						<a target="_blank" class="" href="{{ url('img/belanja/lain/' . $fb->faktur_image) }}">
						 <img src="{{ url('img/belanja/lain/' . $fb->faktur_image) }}" class="img-responsive img-rounded">
						</a>
					</div>
				</div>
			</div>

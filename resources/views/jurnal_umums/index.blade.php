...
@section('page-title') 
 ...
 <ol class="breadcrumb">
      ...
      <li class="active">
          <strong>List Jurnal Umum</strong>
      </li>
</ol>
@stop
@section('content') 
{!! Form::open(['url' => 'jurnal_umums/show', 'method' => 'get']) !!}
<div class="panel panel-default">
  <div class="panel-body">
    <h1>Pilih Jurnal Umum</h1>
    <hr>
    <div class="row">
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
              <a href="{{ url('buku_besars') }}" class="btn btn-danger btn-block btn-lg">Cancel</a>
            </div>
          </div>
        </div>
      </div>

      ...
      <div class="panel-heading">
            <div class="panel-title">
                ...
                <div class="panelRight">
                	<h3> Tanggal : {!! App\Classes\Yoga::updateDatePrep($fakturbelanja->tanggal)!!}</h3>
                </div>
            </div>
      </div>
		  ...
		  <div class="row">
		  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="panel panel-info">
					<div class="panel-body">
						<img src="{{ url('img/belanja/alat/' . $fakturbelanja->faktur_image) }}" class="img-rounded upload" alt="Responsive image">
					</div>
				</div>
		  	</div>
		  </div>

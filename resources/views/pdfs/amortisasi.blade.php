		...
		<table class="table table-hover table-condensed table-custom-bordered">
			...
			<tbody>
					...
					<tr class="border-top">
						...
						<td class="text-right">{{ App\Classes\Yoga::buatrp( $jumlah_penyusutan )}}</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="border-bottom text-right">{{ App\Classes\Yoga::buatrp(0) }}</td>
					...
					<tr class="border-top">
						<td colspan="7">JUMLAH PENYUSUTAN FISKAL</td>
						<td class="text-right">{{ App\Classes\Yoga::buatrp(0)}}</td>
						<td></td>
					</tr>
					<tr>
						<td colspan="7">JUMLAH PENYUSUTAN KOMERSIAL</td>

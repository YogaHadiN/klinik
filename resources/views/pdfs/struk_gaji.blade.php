                ...
                <table>
                    <tbody>
                        ...
                        <tr class="border-top">
                            ...
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($total_gaji) }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{App\Classes\Yoga::buatrp(  $gaji['gaji_bruto']  )}}</td>
                        </tr>
                        @endforeach
                        <tr class="border-top">
                            <td nowrap>Total Gaji Bulan Ini</td>
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->total_bruto) }}</td>
                        </tr>
                        <tr class="border-top">
                            <td class="text-center" colspan="2">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ( {{ App\Classes\Yoga::buatrp($bayar->pph21s->biaya_jabatan) }} )
                            </td>
                        </tr>
                        <tr>
                            <td nowrap>Gaji Netto</td>
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->gaji_netto) }}</td>
                        </tr>
                        <tr>
                            <td nowrap>Gaji Netto Setahun  <strong>{{ App\Classes\Yoga::buatrp($bayar->pph21s->gaji_netto) }} x 12 bulan </strong></td>
                            <td class="text-right"> {{ App\Classes\Yoga::buatrp($bayar->pph21s->gaji_netto * 12) }}</td>
                        </tr>
                        <tr>
                            <td nowrap>
                            ...
                            <td class="text-right">( {{ App\Classes\Yoga::buatrp($bayar->pph21s->ptkp_setahun) }} )</td>
                        </tr>
                        <tr class="border-top">
                            <td nowrap>Penghasilan Kena Pajak</td>
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->penghasilan_kena_pajak_setahun)}}</td>
                        </tr>
                        <tr>
                            @include('pdfs.potongan5persen', ['bayar' => $bayar->pph21s->penghasilan_kena_pajak_setahun])
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->potongan5persen_setahun ) }}</td>
                        </tr>
                        <tr>
                            @include('pdfs.potongan15persen', ['bayar' => $bayar->pph21s->penghasilan_kena_pajak_setahun])
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->potongan15persen_setahun ) }}</td>
                        </tr>
                        <tr>
                            @include('pdfs.potongan25persen', ['bayar' => $bayar->pph21s->penghasilan_kena_pajak_setahun])
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->potongan25persen_setahun ) }}</td>
                        </tr>
                        <tr>
                            @include('pdfs.potongan30persen', ['bayar' => $bayar->pph21s->penghasilan_kena_pajak_setahun])
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->potongan30persen_setahun ) }}</td>
                        </tr>
                        @if(empty( trim(  $bayar->staf->npwp  ) ))
                            ...
                            <tr>
                                <td colspan="2" class="text-right">
                                    1,2 x {{ App\Classes\Yoga::buatrp(
                                        $bayar->pph21s->potongan5persen_setahun +
                                        $bayar->pph21s->potongan15persen_setahun +
                                        $bayar->pph21s->potongan25persen_setahun +
                                        $bayar->pph21s->potongan30persen_setahun
                                    ) }} 
                                    = {{ App\Classes\Yoga::buatrp($bayar->pph21s->pph21_setahun) }}
                                </td>
                            </tr>
                        @endif
                        <tr class="border-top">
                            <td nowrap>Pph21 setahun (simulasi)</td>
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->pph21_setahun) }}</td>
                        </tr>
                        <tr class="border-top">
                            <td nowrap>Pph21 sebulan (simulasi) {{ App\Classes\Yoga::buatrp($bayar->pph21s->pph21_setahun)  }} / 12 = </td>
                            <td class="text-right"> {{ App\Classes\Yoga::buatrp($bayar->pph21s->pph21_setahun / 12)  }}</td>
                        </tr>
                        <tr>
                            <td> pph21 Sudah Dibayarkan Sebelumnya </td>
                            <td class="text-right">({{ App\Classes\Yoga::buatrp($pph21_sudah_dibayar_sebelumnya) }})</td>
                        </tr>
                        <tr class="border-top">
                            <td nowrap>Pph21 dibayarkan sekarang</td>
                            <td class="text-right">{{ App\Classes\Yoga::buatrp($bayar->pph21s->pph21) }}</td>
                        </tr>
                        <tr class="border-top">
                            <td colspan="2">Gaji Yang Dibayarkan Sekarang = {{ App\Classes\Yoga::buatrp( $bayar->pph21s->gaji_bruto ) }} ({{ App\Classes\Yoga::buatrp($bayar->pph21s->pph21) }}) </td>
                        </tr>
                        @endif
                        <tr class="border-top">
                        ...
                        <tr>
                            <td colspan="2" class="text-right">
                                <h2 id="pembayaranDokter">
                                    {{ App\Classes\Yoga::buatrp( $total_gaji  - $bayar->pph21s->pph21) }}
                                </h2>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">{{ App\Classes\Yoga::terbilang( $total_gaji  - $bayar->pph21s->pph21) }} rupiah</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ App\Classes\Yoga::buatrp( $g['gaji_bruto'] ) }}</td>
                            <td class="text-right">{{ App\Classes\Yoga::buatrp( $g['pph21'] ) }}</td>
                            <td class="text-right">{{ App\Classes\Yoga::buatrp( $g['gaji_bruto'] - $g['pph21'] ) }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
                        <tr>
                            <th>TOTAL</th>
                            <th class="text-right">{{ App\Classes\Yoga::buatrp( $bayar->pph21s->total_bruto ) }}</th>
                            <th class="text-right">{{ App\Classes\Yoga::buatrp( $bayar->pph21s->total_pph21 ) }}</th>
                            <th class="text-right">{{ App\Classes\Yoga::buatrp( $bayar->pph21s->total_bayar ) }}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>

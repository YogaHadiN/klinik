                ...
                <div class="box">
                    <table>
                        <tbody>
							...
							<tr>
                                <td colspan="2" class="text-right">
                                    <h2 id="pembayaranDokter">
                                        {{ App\Classes\Yoga::buatrp( $bayar->nilai ) }}
							...
							<tr class="border-top">
								<td>Gaji Saat Ini</td>
								<td class="text-right">{{ App\Classes\Yoga::buatrp( $bayar->nilai ) }}</td>
							</tr>
							<tr>
								<td>Biaya Jabatan</td>
								<td class="text-right">( {{ App\Classes\Yoga::buatrp( $bayar->biaya_jabatan ) }} )</td>
							</tr>
							<tr class="border-top">
								<td>Gaji Netto</td>
							...
							<tr>
								<td>{{ App\Classes\Yoga::buatrp( $bayar->gaji_netto ) }} x 12 bulan = </td>
							...
							<tr class="border-top">
								...
								<td class="text-right">{{ App\Classes\Yoga::buatrp((  $bayar->gaji_netto * 12  ) - $bayar->ptkp ) }}</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>{{ App\Classes\Yoga::buatrp($bayar->pph21setahun) }} / 12 bulan</td>
                            </tr>
							<tr>
								<td colspan="2" class="text-right"><h2>{{ App\Classes\Yoga::buatrp($bayar->pph21) }}</h2></td>
                            </tr>
							<tr class="border-top">
                                <td colspan="2">Total</td>
                            </tr>
							<tr>
                                <td class="text-right" colspan="2">
                                    <h2 id="pembayaranDokter">
										{{ App\Classes\Yoga::buatrp( $bayar->nilai -  $bayar->pph21 ) }}
                                    </h2>
                                </td>
							</tr>
							<tr>

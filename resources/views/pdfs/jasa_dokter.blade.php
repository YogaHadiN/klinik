                        ...
                        {{--<tbody>--}}
							{{--@if(count(  json_decode( $bayar->perhitungan_pph, true )  ) > 0)--}}
								{{--@foreach(json_decode(  $bayar->perhitungan_pph , true ) as $k=> $r) --}}
									{{--<tr>--}}
										{{--<td>{{ $k }}</td>--}}
										{{--<td class="text-right">{{App\Classes\Yoga::buatrp(  $r['penghasilan_bruto_bulan_ini']  )}}</td>--}}
										{{--<td class="text-right">{{App\Classes\Yoga::buatrp(  $r['ptkpBulanIni']  )}}</td>--}}
										{{--<td class="text-right">{{App\Classes\Yoga::buatrp(  $r['pph']  )}}</td>--}}
									{{--</tr>--}}
								{{--@endforeach--}}
							{{--@endif--}}
						{{--</tbody>--}}

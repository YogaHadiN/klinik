					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<div class="form-group @if($errors->has('status_harta_id'))has-error @endif">
								...
								{!! Form::select('status_harta_id', App\StatusHarta::list(), null, array(
									'class'         => 'form-control rq',
					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<div class="form-group @if($errors->has('metode_bayar_id'))has-error @endif">
								...
								{!! Form::select('metode_bayar_id', App\MetodeBayar::list(), null, array(
									'class'         => 'form-control rq',
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-group @if($errors->has('tax_amnesty'))has-error @endif">
								...
								{!! Form::select('tax_amnesty', App\Classes\Yoga::pilihan('Tax Amnesty'), null, array(
									'class'         => 'form-control rq'
								))!!}

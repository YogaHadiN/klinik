...
<div class="panel panel-primary">
      <div class="panel-heading">
            <div class="panel-title">
                <div class="panelLeft">
                    <h3>List Pengeluaran tanggal {!! App\Classes\Yoga::updateDatePrep($mulai) !!} - {!! App\Classes\Yoga::updateDatePrep($akhir) !!}</h3>
                </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="tableAsuransi">
                ...
                <tbody>
                     ...
                     <tr>
                       ...
                       <td>
                         {!! App\Classes\Yoga::updateDatePrep($nota->tanggal) !!}
                       </td>
                       <td>
                         {!! $nota->supplier->nama !!}
                       </td>

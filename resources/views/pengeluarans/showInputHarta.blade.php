					...
					<div class="table-responsive">
						<table class="table table-hover table-condensed table-bordered">
							<tbody>
								...
								<tr>
									<td>Harga Beli</td>
									<td class="text-right">{{App\Classes\Yoga::buatrp(  $harta->harga  )}}</td>
								</tr>
								<tr>
									<td>Harga Jual</td>
									<td class="text-right">{{ App\Classes\Yoga::buatrp( $harta->harga_jual ) }}</td>
								</tr>
								<tr>
									<td>Penyusutan</td>
									<td class="text-right">{{ App\Classes\Yoga::buatrp( $harta->penyusutan ) }}</td>
								</tr>
								<tr>
									<td>Tax Amensty</td>

				...
				<div class="panel-body">
					<div class="row">
										...
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												<div class="form-group @if($errors->has('sumber_uang_id'))has-error @endif">
													...
													{!! Form::select('sumber_uang_id', App\Classes\Yoga::sumberuang(), null, array(
														'class'         => 'form-control '
													))!!}
						...
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<div>
								<img src="{{ url('img/gojek.png') }}" class="img-round full-width" alt="Responsive image">
							</div>
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<div class="panel-title">
						...
						<div class="panelLeft">
							<h3 class="text-right">
								Total : {{ App\Classes\Yoga::buatrp( $total ) }}
							</h3>
						</div>
					</div>
				</div>
							...
							<tbody>
								@if($ggs->count() > 0)
									@foreach( $ggs as $gg )
										...
										<td>{{ $gg->keterangan }}</td>
										@if( $gg->debit )
											<td class="text-right">{{App\Classes\Yoga::buatrp(  $gg->nilai  )}}</td>
										@else
											<td></td>
										@endif
										@if( !$gg->debit )

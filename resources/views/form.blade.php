    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  <div class="form-group @if($errors->has('gener')) has-error @endif">
			...
			{!! Form::select('generik_id' , App\Generik::list(), null, [ 'data-live-search' => 'true', 'class' => 'form-control selectpick', 'onchange' => 'generik_list_change();return false;', 'id' => 'generik_list_alergi']) !!}

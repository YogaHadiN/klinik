        ...
        $(document).ready(function() {
            ...
            $('#inputKomposisi').click(function(e) {
                ...
                $('#dummySubmit').click(function(e) {
                    ...
                    $('select[name="golongan_obat"]').closest('.form-group').find('code').remove();
                    ...
                    if(
                            ...
                            if($('select[name="golongan_obat"]').val() == '' ){
                                validasi('select[name="golongan_obat"]', 'Harus diisi');
                            }
                            ...
                            $.post(base + "/formulas/ajax/ajaxformula", {'json': json, 'merek' : $('#merek').val(), 'sediaan' : $('#sediaan').val(), 'rak_id' : $('#rak_id').val()}, function(data) {
                                ...
                                if( data.formula == '1' || data.merek == '1' || data.rak == '1' ){
                                    if(data.formula == '1'){
                                        ...
                                        temp += '<div><code>Buat <a href="">Rak Baru</a> dengan formula yang sama</code></div>';
                                        temp += '<div><code>Buat <a href="">Formula Baru</a> dengan komposisi yang berbeda</code></div>';
...
;
                                        ...
                                        for (var i = 0; i < lists.length; i++) {
                                            ...
                                            temp += '<td><a href="#" class="btn btn-success btn-xs">merek baru</a></td>';
                                            temp += '</tr>';
                                        };
                                        temp += '</tbody>';
                                        temp += '</table>';
